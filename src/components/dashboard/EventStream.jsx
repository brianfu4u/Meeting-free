...
const TYPE_CONFIG = {
  ...
  info: {
    icon_bg: "rgba(0,199,217,0.12)",
    icon_color: "#00C7D9",
    border: "rgba(0,199,217,0.15)",
    bg: "rgba(0,199,217,0.03)",
    dot: "#00C7D9",
  },
  success: {
    icon_bg: "rgba(22,163,74,0.15)",
    icon_color: "#4ade80",
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2 mb-1">
            <span
              ...
              style={{
                color: event.awaitConfirm ? "#f87171" : event.type === "critical" ? "#f87171" : "#94A3B8",
                fontSize: "10px",
            ...
            <span className="text-xs flex-shrink-0" style={{ color: "#475569", fontSize: "10px" }}>
              {event.time}
            </span>
          </div>
          <p className="text-xs leading-relaxed" style={{ color: "#CBD5E1", fontSize: "12px" }}>
            {event.message}
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderBottom: "1px solid #1E3352" }}
      >
        <div className="flex items-center gap-2">
          <div
            className="w-2 h-2 rounded-full"
            style={{ background: "#00C7D9", animation: "pulseGreen 2s ease-in-out infinite" }}
          />
        ...
        <span
          ...
          style={{ background: "rgba(0,199,217,0.12)", color: "#00C7D9", border: "1px solid rgba(0,199,217,0.25)", fontSize: "10px" }}
        >
          AI 智能监控
        </span>
      </div>
      ...
      <div
        ...
        style={{ borderTop: "1px solid #1E3352", background: "rgba(0,0,0,0.2)" }}
      >
        {actionDone ? (
          <div
          ...
          <>
            ...
            >
              ...
              <div className="text-xs" style={{ color: "#CBD5E1" }}>
                将视光师X调入检查区3号位，预计等待时间降至15分钟以内。
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={onConfirm}
                className="py-2.5 rounded-xl text-xs font-bold transition-all duration-150 active:scale-95"
                style={{
                  background: "linear-gradient(135deg, #00C7D9, #0099A8)",
                  color: "#0D1B2A",
                  boxShadow: "0 0 16px rgba(0,199,217,0.35)",
                }}
              >
                ✓ 确认
              </button>
              <button
                ...
                style={{
                  ...
                  color: "#00C7D9",
                  border: "1px solid rgba(0,199,217,0.35)",
                }}
              >
                📡 下发指令
              </button>
              <button
                onClick={onDefer}
                className="py-2.5 rounded-xl text-xs font-medium transition-all duration-150 active:scale-95"
                style={{
          ...
          <div className="text-center py-2">
            ...
            <div className="text-xs mt-1" style={{ color: "#334155", fontSize: "10px" }}>
              系统持续监控中...
            </div>
          </div>
        )}
