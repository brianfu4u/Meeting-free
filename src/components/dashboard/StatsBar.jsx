...
export default function StatsBar({ panels }) {
  ...
  return (
    <div
      ...
      style={{ background: "#111F30", border: "1px solid #1E3352" }}
    >
      <span className="text-xs font-semibold" style={{ color: "#64748B", letterSpacing: "0.05em", fontSize: "10px" }}>
        系统概况
      </span>
      ...
      <div className="ml-auto text-xs" style={{ color: "#475569", fontSize: "10px" }}>
        共 9 个板块在监控
      </div>
    </div>
  );
